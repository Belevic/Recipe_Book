namespace RecipeBook.Gui
{
    partial class EditRecipe
    {
        ...
        private void Initialize()
        {
            ...
            ComboBoxOfItemName.Name = "ComboBoxOfItemName";
            ...
            ComboBoxOfAmount.Name = "ComboBoxOfAmount";
            ...
            checkBoxColumn.HeaderText = "Add to List";
            ...
            Controls.Add(steps);
            Controls.Add(createNewItem);
            Controls.Add(ingredientsTable);
            Controls.Add(adding);
            Controls.Add(ComboBoxOfAmount);
            Controls.Add(amount);
            Controls.Add(ingredients);
            Controls.Add(ComboBoxOfItemName);
