...
![Окно для просмотра сохраненных рецептов](../Documentation/Mockups/Recipe_list.png) 
...
**Описание.**  Приложение должно предоставить возможность ввода названия и типа ингредиента.

**Требование.** Характеристики вводимые пользвателем не должны совпадать с параметрами ингредиентов сохраненных в базе данных.
...
**Описание.**  Пользователь при создании нового рецепта должен ввести список необходимых ингредиентов и их количество.

**Требование.** Добавление продукта из базы данных с указанием количественного соотношения их в данном блюде.

<a name ="step_instruction"><a/>

##### 3.2.1.2.1 Ввод пошаговой интсрукции по приготовлению

**Описание.**  Для добавления рецепта необходима пошаговая инструкция по приготовлению данного блюда.

**Требование.** Описание процесса приготовления пошагово.
